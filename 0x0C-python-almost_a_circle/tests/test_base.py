...
Testbase_instances(unittest.TestCase -line 4)
Testbase_to_json(unittest.TestCase -line 77)
Testbase_from_json(unittest.TestCase -line 123)
Testbase_save_file(unittest.TestCase -line 176)
Testbase_load_file(unittest.TestCase -line 273)
Testbase_create(unittest.TestCase -line 328)
...
class Testbase_from_json(unittest.TestCase):
    ...
    def test_from_json_dictRx2(self):
        linput = [
                {"id": 89, "width": 10, "height": 4, "x": 2, "y": 1},
